...
def get_object_properties(args):
   ...
   print('\n')
   print(' USED PARAMETERS '.center(40, '*'))
   print('-R.A.: %s deg.'%args.ra)
   print('-Dec: %s deg.'%args.dec)
   print('-PM(R.A.): %s mas.'%args.ra)
   print('-PM(Dec): %s mas.'%args.dec)
   print('-Distance: %s kpc.'%args.distance)
   print('-[Fe/H]: %s dex.'%round(args.feh, 4))
